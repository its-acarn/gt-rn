...
export default function AddVisitScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'Add Visit', presentation: 'modal', headerShown: true }} />
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.row}>
          ...
          >
            <Text style={[styles.toggleText, holesPlayed === 9 && styles.toggleTextActive]}>
              9 holes
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Text style={[styles.toggleText, holesPlayed === 18 && styles.toggleTextActive]}>
              18 holes
            </Text>
          </TouchableOpacity>
        </View>
